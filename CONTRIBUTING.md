...
issue](https://github.com/cisagov/session-manager-tf-module/issues) in this
...
request](https://github.com/cisagov/session-manager-tf-module/pulls), you
...
```console
cd session-manager-tf-module
pyenv virtualenv <python_version_to_use> session-manager-tf-module
pyenv local session-manager-tf-module
